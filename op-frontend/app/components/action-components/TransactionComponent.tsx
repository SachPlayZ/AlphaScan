                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-gray-800/50">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          `https://chainscan-galileo.0g.ai/tx/0x${details.approve_transaction_hash}`,
                          "_blank"
                        )
                      }
                      className="h-8 w-8 p-0"
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-gray-800/50">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          `https://chainscan-galileo.0g.ai/tx/0x${details.sell_transaction_hash}`,
                          "_blank"
                        )
                      }
                      className="h-8 w-8 p-0"
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-gray-800/50">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          `https://chainscan-galileo.0g.ai/tx/0x${details.transaction_hash}`,
                          "_blank"
                        )
                      }
                      className="h-8 w-8 p-0"
