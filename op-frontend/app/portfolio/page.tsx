...
import { WalletData, updateOGBalance } from "@/lib/wallet";
    ...
    const fetchWallet = async () => {
      ...
      try {
        ...
        if (walletData) {
          ...
          const updatedWallet = await updateOGBalance(parsedWallet);
          ...
          <Card className="glass-card rounded-3xl">
            ...
            <CardContent>
              ...
              <div className="text-sm text-gray-400 mt-1">
                {wallet && `0G Balance: ${wallet.ogBalance.toFixed(4)} 0G`}
              </div>
            </CardContent>
          </Card>
